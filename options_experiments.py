...
def planning_experiments(task='spread'):
    '''
    Summary:
...
def learning_experiments():
   ...
   run_agents_lifelong([ql_agent, rand_agent, option_agent], mdp_distr, samples=5, episodes=100, steps=150)


def main():
    # learning_experiments()
    planning_experiments('tight')
